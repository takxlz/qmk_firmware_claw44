...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_1] = LAYOUT(
    ...
    // .-------------+-------------+-------------+-------------+-------------+-------------.                  .-------------+-------------+-------------+-------------+-------------+-------------.
        KC_F12       , KC_F6       , KC_F7       , KC_F8       , KC_F9       , KC_F10      , XXXXXXX, XXXXXXX, _______      , _______     , _______     , _______     , _______     , S(KC_INT1)  ,
    // .-------------+-------------+-------------+-------------+-------------+-------------.                  .-------------+-------------+-------------+-------------+-------------+-------------.
                                     TK_BACK     , TK_FWRD     , _______     , KC_DEL      ,                   _______      , _______     , _______     , _______
    // ,                            -------------------------------------------------------.                  .-------------------------------------------------------.
   ),
